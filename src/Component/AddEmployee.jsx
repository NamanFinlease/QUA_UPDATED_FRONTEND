                        ...
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                ...
                                >
                                    ...
                                    >
                                        <MenuItem value="M" sx={{ background: colors.white[100], color: colors.black[100], ':hover': { background: colors.primary[400], color: colors.white[100] } }}>Male</MenuItem>
                                        <MenuItem value="F" sx={{ background: colors.white[100], color: colors.black[100], ':hover': { background: colors.primary[400], color: colors.white[100] } }}>Female</MenuItem>
                                    </Select>
                                    {fieldState.error && (
