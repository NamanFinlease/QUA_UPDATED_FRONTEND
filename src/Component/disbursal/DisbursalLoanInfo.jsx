...
//                     <tbody>
//                         {info.map((field, index) => (
//                             <tr key={index} style={{ borderBottom: `2px solid ${colors.primary[400]}` }}>
//                                 <td style={{ fontWeight: "bold", padding: "10px", width: "50%", whiteSpace: "nowrap" }}>
//                                     {field.label}
//                                 </td>
//                                 <td style={{ padding: "10px", whiteSpace: "nowrap" }}>
//                                     {field.value} {field.label === "ROI % (p.d.) Approved" && "%"}
//                                 </td>
//                             </tr>
//                         ))}
//                     </tbody>
