    ...
    recommendApplication: builder.mutation({
      ...
      invalidatesTags:["recommendedApplications"]
        ...
        fetchAllApplication: builder.query({
            query: ({ page, limit }) =>
                `/applications/?page=${page}&limit=${limit}&role=${role()}`,
            providesTags: ["getApplication"],
        }),
        fetchAllocatedApplication: builder.query({
            query: ({ page, limit }) =>
                `/applications/allocated/?page=${page}&limit=${limit}&role=${role()}`,
            providesTags: ["getApplication"],
        }),
        ...
        eSignPending: builder.query({
            query: ({ page, limit }) =>
                `/sanction/eSignPending/?role=${role()}`,
        ...
        recommendedApplications: builder.query({
            query: ({ page, limit }) =>
                `/sanction/recommended/?page=${page}&limit=${limit}&role=${role()}`,
        ...
        fetchDisbursalHold: builder.query({
            query: ({ page, limit }) =>
                `/disbursals/hold/?page=${page}&limit=${limit}&role=${role()}`,
            // providesTags:["getApplication"]
        }),
        ...
        exportNewDisbursal: builder.query({
            query: () => `/disbursals/new/report/?role=${role()}`,
        }),
        ...
        exportMasterCollection: builder.query({
            query: () => `/reports/masterCollection/?role=${role()}`,
        }),
    }),
});
export const {
